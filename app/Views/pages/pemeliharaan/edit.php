                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Pemeliharaan - Tambah</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <form action="<?= site_url('/pemeliharaan/update/' . $pemeliharaan['pemeliharaan']['id']) ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1"
                                    ...
                                    value="<?= $pemeliharaan['pemeliharaan']['nama'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Jumlah</label>
                                <input type="number" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" name="jumlah"
                                    value="<?= $pemeliharaan['pemeliharaan']['jumlah'] ?>">
                            </div>
                            <div class="mb-3">
