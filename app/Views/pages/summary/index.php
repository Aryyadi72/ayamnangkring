                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">List Summary Harian</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="justify-content-end">
                <a href="<?= base_url('/summary-harian/before_create') ?>" class="btn btn-primary">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h5>List Summary Harian</h5>
                            </div>
                            <div class="col-auto">
                                <a href="<?= base_url('/summary-harian/filter') ?>" class="btn btn-warning">
                                ...
                                foreach ($summaryHarian['summaryHarian'] as $sh):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('/summary-harian/detail/' . $sh['id']) ?>" target="blank_"
...
<!-- [ Main Content ] end -->
<script>$('#summary-harian').DataTable();</script>
