...
<div class="row">
    ...
    <p><?= $transaction['customers'] ?? '' ?></p> <!-- Replace 'customer_name' with the actual column name from your database -->
    
    <label for="exampleInputEmail1" class="form-label"><strong>Kasir :</strong></label>
    <p>Kasir</p> <!-- Replace 'cashier' with the actual column name from your database -->
</div>
                </div>
                <div class="col-4">
                    <div>
                        ...
                        <label for="exampleInputEmail1" class="form-label">
                            ...
                            <span class="badge badge-success rounded-pill border"><?= $transaction['payment_method'] ?? '' ?></span>
                        </label>
                        <br>
                        <label for="exampleInputEmail1" class="form-label"><strong>Status :</strong> <?= $transaction['status'] ?? '' ?> </label>
                    </div>
                </div>
                <div class="col-4">
                    <div>
                        <label for="exampleInputEmail1" class="form-label"><strong>ID Pesanan :</strong> <br> </label>
                        <p><?= $transaction['id'] ?? '' ?></p>
                        <!-- <br> -->
                        <label for="exampleInputEmail1" class="form-label"><strong>Tanggal :</strong> <br> </label>
                        <p><?= $transaction['created_at'] ?? '' ?></p>
                    </div>
                </div>
            </div>
        ...
        <tr>
            ...
            <td>
                <div class="input-group">
                    ...
                    <p id="jumlah" class="text-center ml-2 mr-2"><?= $detail['quantity'] ?></p>
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="productQty" name="qty" value="<?= date('Y-m-d'); ?>" readonly>
</div>
</div>
